...
namespace ApiCatalogoJogos.Controllers.V1
{
    ...
    {
        private readonly IJogoService _jogoService; //Contrato para uso

        #region //Construtor da API


        public JogosController(IJogoService jogoService)
        {
            _jogoService = jogoService; // recebe a Instancia do IJogoService
        }
        #endregion


        #region // Solicitar e mostra as páginas dos jogos do Catálogo que estão cadastradas
        ...
        #region // Solicitar e mostra o jogo pelo o ID desejado
        /// <summary>
